...
<script>
    ...
    const map = L.map('map', {
	center: [-6.941958290418135, 110.26614693723177],
	zoom: 12,
	layers: [peta5]
    });
    ...
    //Marker
    L.marker([-6.941958290418135, 110.26614693723177]).bindPopup("<b>Contoh</b><br>" +
                                                                "Jalan Kenangan Bersamamu <br>" + 
                                                                "08123456789").addTo(map);

    L.marker([-6.967158621981152, 110.26270939920336]).addTo(map);

    L.marker([-6.915441258573997, 110.25464131405094]).addTo(map);

    L.marker([-6.931885781075402, 110.27978970533371]).addTo(map);

    L.marker([-6.931885780997186, 110.29403759928496]).addTo(map);
