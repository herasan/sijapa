    ...
    <div class="panel-body">
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-xs btn-success" data-toggle="modal" data-target="#edit<?= $value->id_usul?>"><i class="fa fa-pencil"></i> Edit </button>
                        <a href="<?= base_url('tabel_perencanaan/hapus/'. $value->id_usul)?>" onclick="return confirm('Apakah Data Ini Yakin Akan Dihapus?')" class="btn btn-xs btn-danger" ><i class=" fa fa-trash"></i> Hapus</a>
                    </td>
                    <td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Tambah Data Perencanaan Jaringan Prasarana</h4>
                </div>
                <div class="modal-body">
                
                <?php echo form_open_multipart('tabel_perencanaan/tambah'); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="tujuan" placeholder="Tujuan Perencanaan Jaringan Prasarana" required>
...
<!-- /.modal add data -->
 ...
 <div class="modal fade" id="edit<?= $value->id_usul?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">Edit Data Perencanaan Jaringan Prasarana</h4>
                </div>
                <div class="modal-body">
                
                <?php echo form_open('tabel_perencanaan/edit/'. $value->id_usul); ?>
                <div class="form-group">
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Nama Pelapor</label>
                        <input class="form-control" type="text" name="nama_pelapor" value="<?=$value->nm_usul?>" placeholder="Nama Pelapor" required>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Alamat Pelapor</label>
                        <input class="form-control" type="text" name="alamat_pelapor" value="<?=$value->al_usul?>" placeholder="Alamat Pelapor" required>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Jenis Jaringan Prasarana</label>
                        <select class="form-control" name="jenis_jaringan" value="<?=$value->jenis_jaringan?>" placeholder="Jenis Jaringan Prasarana" required>
                            <option value="">--Pilih Jenis Jaringan Prasarana--</option>
                            <option>Jaringan Air Minum</option>
                            <option>Jaringan Infrastruktur Pengelolaan Air</option>
                            <option>Jaringan Drainase</option>
                            <option>Jaringan Energi</option>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Tujuan Perencanaan</label>
                        <input class="form-control" type="text" name="tujuan" placeholder="Detail Kerusakan" required>
                    </div>
                </div> 
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Detail Lokasi</label>
                        <input class="form-control" type="text" name="detail_lokasi" value="<?=$value->detail_lokasi?>" placeholder="Alamat Lokasi Kerusakan Jaringan Prasarana" required>
                    </div>
                </div> 
